...
sub usage {				# Usage message - print and exit when script called without arguments
    print STDERR "\n";
    print STDERR "FASTG format parsing tool - Brandon Seah 2014-10-15 - Caveat emptor              \n";
    print STDERR "Usage:                                                                           \n";
    print STDERR " \$ perl fastg_parser_04.pl -i <input.fastg> -b <bait.list> -o <output_prefix>    \n";
    print STDERR "\n";
    print STDERR "Options:\n";
    print STDERR " \t -i FILE     Input Fastg formatted file \n";
    print STDERR " \t -b FILE     File with list of contigs, one per line, as bait to retrieve connected contigs \n";
    print STDERR " \t -o STRING   Output prefix for output of parser tool \n";
    print STDERR " \t -r          Switch used by genome_bin_tools.r; writes list of connected contigs to STDOUT\n";
    print STDERR "\n";
    print STDERR "Output:                             \n";
